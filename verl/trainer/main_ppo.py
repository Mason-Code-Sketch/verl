...
def run_ppo(config) -> None:
    ...
    if not ray.is_initialized():
        ...
        ray.init(
            runtime_env={"env_vars": {"TOKENIZERS_PARALLELISM": "true", "NCCL_DEBUG": "WARN", "VLLM_LOGGING_LEVEL": os.getenv("VLLM_LOGGING_LEVEL", "WARN"), "VLLM_ALLOW_RUNTIME_LORA_UPDATING": "true"}},
